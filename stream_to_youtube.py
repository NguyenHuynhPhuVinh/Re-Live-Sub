...
Yêu cầu: FFmpeg, YouTube Live stream key
"""
...
class YouTubeLiveStreamer:
    ...
    def stream_playlist(self, video_dir, pattern="*_sub.mp4", loop=False):
        """
        Stream playlist các video
...
def main():
    ...
    if choice == '1':
        ...
        streamer.stream_playlist(video_dir, pattern, loop=loop)
